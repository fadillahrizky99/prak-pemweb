        ...
        <div class="post">
            ...
            <div class="form">
                <form action="" method="get">
                    <label for="search" class="lbl">Pilih Program Studi:</label>
                    <select name="search" class="in2">
                        <option value="">Semua Program Studi</option>
                        <option value="AR">Arsitektur (AR)</option>
                        <option value="FA">Farmasi (FA)</option>
        ...
        <div class="post">
            ...
            <div class="form">
                <form action="" method="post">
                    ...
                    <label for="prodi" class="lbl">Prodi:</label>
...
<div class="post">
            ...
            <div class="form">
                <form action="" method="post">
                    <label for="edit" class="lbl">NIM data yang diedit:</label>
        ...
        <div class="post">
            ...
            <div class="form">
                <form action="" method="get">
                    <label for="del" class="lbl">NIM data yang dihapus:</label>
